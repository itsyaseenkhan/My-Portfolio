...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(
      "https://my-portfolio-q3dv.onrender.com/api/v1/UserRouter/Password/forgot",
      { email },
...
const adminPort = import.meta.env.VITE_BACKEND_URL
  ...
  (token, password, confirmPassword) => async (dispatch) => {
    try {
      ...
      const response = await axios.put(
        `https://my-portfolio-q3dv.onrender.com/api/v1/UserRouter/Password/reset/${token}`,
